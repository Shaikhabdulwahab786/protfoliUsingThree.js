...
const ServiceCard = ({index , title ,icon}) =>{
  ...
  return(
    <Tilt className ='xs:-[250px] w-1400 ' >
      <motion.div
      ...
      <div
       ...
       px-12 min-h-[280px] flex justify-evenly items-center flex-col'
         >
          <img src={icon} alt={title} className ="w-16 h-10 object-contain" />
...
const About = () => {
  ...
  return (
   ...
   className ='mt-t text-secondary text-[17px]
   max-w-3xl leading-[30px]'
   >
     I'm  a skilled softwere developer with exprience
      in React  , Nodes.js
   </motion.p>
